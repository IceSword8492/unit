    ...
    Room d[8][5] = {
        {
            ...
            new_Room(04, "çwîÉ", goShop, "goShop", 0b100, .0f)
        },
        {
        ...
        },
        {
            ...
            new_Room(44, "çwîÉ", goShop, "goShop", 0b100, .0f)
        },
        {
        ...
        {
            new_Room(60, "çwîÉ", goShop, "goShop", 0b001, .0f),
            new_Room(61, "çwA202", NULL, "", 0b101, .5f),
            new_Room(62, "å§A503", NULL, "", 0b111, .5f),
            new_Room(63, "å§B201", NULL, "", 0b101, .5f),
            new_Room(64, "å§302", pickUpText, "pickUpText", 0b100, .5f)
        },
        {
            new_Room(71, "ë≤ã∆", gameClear, "gameClear", 0b000, .0f),
